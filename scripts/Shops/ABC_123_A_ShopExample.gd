...
@onready var shopkeeperSprite : Sprite2D = get_node("Shopkeeper")
...
func _ready() -> void:
	signalManager.connect("talk", Callable(self, "_on_talk_choice"))
	signalManager.connect("buff_signal", Callable(self, "_on_buff_signal_activated"))
	tieInter.connect("buff_end", Callable(self, "_on_buff_end"))
	tieInter.connect("typesound", Callable(self, "_on_Typesound"))
	tieBuy.connect("typesound", Callable(self, "_on_Typesound"))
	tieInter.connect("buff_end", Callable(self, "_on_stop_type"))
	tieInter.connect("enter_break", Callable(self, "_on_stop_type"))
	tieBuy.connect("buff_end", Callable(self, "_on_stop_type"))
	tieBuy.connect("enter_break", Callable(self, "_on_stop_type"))
	greeting()
