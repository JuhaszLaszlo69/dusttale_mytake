...
func _ready():
	...
	tie.connect("input_enter", Callable(self, "_on_input_enter"))
	tie.connect("buff_end", Callable(self, "_on_buff_end"))
	tie.connect("state_change", Callable(self, "_on_state_change"))
	tie.connect("enter_break", Callable(self, "_on_enter_break"))
	tie.connect("resume_break", Callable(self, "_on_resume_break"))
	tie.connect("tag_buff", Callable(self, "_on_tag_buff"))
	#tie.connect("typesound", self, "_on_Typesound")
	options_script.connect("player_choice", Callable(self, "_on_choice"))
	pass
